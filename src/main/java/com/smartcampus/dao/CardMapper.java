...
public interface CardMapper {
    ...
    @Insert("insert into card (card_vid,card_balance,sq_id,auth_id,state) values (#{uuid},#{balance},#{id},'1','0')")
    void save(@Param("uuid")String uuid,@Param("balance")String balance,@Param("id")String id);
