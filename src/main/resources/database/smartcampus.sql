...
CREATE TABLE `card`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `sq_id`(`sq_id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 's1', 's1', '0', '0', 1, '1');
INSERT INTO `user` VALUES ('2', 's2', 's2', '1', '1', 1, '1');
INSERT INTO `user` VALUES ('3', 't1', 't1', '0', '2', 0, '0');
INSERT INTO `user` VALUES ('4', 't2', 't2', '1', '0', 0, '0');
